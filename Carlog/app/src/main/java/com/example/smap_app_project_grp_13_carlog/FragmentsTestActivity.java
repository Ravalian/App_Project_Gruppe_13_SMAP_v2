...
public class FragmentsTestActivity extends AppCompatActivity implements YourLogsSelectorInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.list_container, yourLogsList, LIST_FRAG)
                    .add(R.id.details_container, yourLogsDetails, DETAILS_FRAG)
                    .commit();
        } else {
    ...
    public void onYourLogSelected(int position) {
        if (yourLogsDetails != null) {
            LogsTest selectedLog = yourlogs.get(position);
            if (selectedLog != null) {
    ...
    public ArrayList<LogsTest> getYourLogsList() { return yourlogs; }
